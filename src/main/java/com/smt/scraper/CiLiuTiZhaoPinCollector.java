...
@Component
public class CiLiuTiZhaoPinCollector extends FiveDoubleOneEightScraper {
    private Logger logger = LoggerFactory.getLogger(CiLiuTiZhaoPinCollector.class);
    ...
    private String projectId="97fc98c9-09ef-ec11-8dbb-c81f66f777c4";
