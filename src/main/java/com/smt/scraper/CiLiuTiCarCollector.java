...
@Component
public class CiLiuTiCarCollector extends FiveDoubleOneEightScraper {
    private Logger logger = LoggerFactory.getLogger(CiLiuTiCarCollector.class);
    ...
    private String projectId="6c816dcb-56f8-ec11-8dbb-c81f66f777c4";
