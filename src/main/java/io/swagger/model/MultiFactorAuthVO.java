...
public class MultiFactorAuthVO   {
  ...
  @Schema(description = "")
  private String optAuthUrl = null;
  ...
  **/
  ...
  public MultiFactorAuthVO mfaKey(String mfaKey) {
    this.mfaKey = mfaKey;
    return this;
  }
  ...
  **/
  ...
  public MultiFactorAuthVO mfaType(MfaTypeEnum mfaType) {
    this.mfaType = mfaType;
    return this;
  }
 ...
 /**
   ...
   * @return optAuthUrl
  **/
  @JsonProperty("optAuthUrl")
  public String getOptAuthUrl() {
    return optAuthUrl;
  }

  public void setOptAuthUrl(String optAuthUrl) {
    this.optAuthUrl = optAuthUrl;
  }

  public MultiFactorAuthVO optAuthUrl(String optAuthUrl) {
    this.optAuthUrl = optAuthUrl;
    return this;
  }
  ...
  **/
  ...
  public MultiFactorAuthVO qrImage(String qrImage) {
    this.qrImage = qrImage;
    return this;
  }
