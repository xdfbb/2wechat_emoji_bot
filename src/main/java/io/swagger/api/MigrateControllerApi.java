 ...
 */
@Path("/")
public interface MigrateControllerApi  {
     ...
     */
    @POST
    @Path("/api/admin/migrations/halo")
    @Consumes({ "multipart/form-data" })
    @Operation(summary = "Migrate from Halo", tags={  })
    @ApiResponses(value = { 
    ...
    public void migrateHaloUsingPOST( @Multipart(value = "file" , required = false) Attachment fileDetail);
}
